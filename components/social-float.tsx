        ...
        return (
          ...
          >
            ...
            <div
              ...
              style={{
                background: isHovered ? social.color : "rgba(255,255,255,0.1)",
                color: isHovered ? "#fff" : social.color,
                transform: isHovered ? "scale(1.15)" : "scale(1)",
                boxShadow: isHovered ? `0 0 25px ${social.color}` : "none",
              }}
            >
              {social.icon}
            </div>
            ...
            {/* Tooltip */}
            <div
              className="absolute right-full mr-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-lg whitespace-nowrap transition-all duration-300 pointer-events-none"
              style={{
                background: social.color,
